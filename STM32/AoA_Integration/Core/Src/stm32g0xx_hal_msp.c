...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(TIM1_CH1_HCSR1_ECHO_GPIO_Port, TIM1_CH1_HCSR1_ECHO_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM14_MspDeInit 0 */
    ...
    PB1     ------> TIM14_CH1
    */
    HAL_GPIO_DeInit(TIM14_CH1_ECHO_GPIO_Port, TIM14_CH1_ECHO_Pin);
  ...
  /* USER CODE END TIM17_MspDeInit 0 */
    ...
    PB9     ------> TIM17_CH1
    */
    HAL_GPIO_DeInit(TIM17_CH1_ECHO_GPIO_Port, TIM17_CH1_ECHO_Pin);
